...
forall (p_pre: Z) (l: (@list Constraint)) (n: Z) (x_155: Constraint) (l0_156: (@list Constraint)) (y_157: Z) (h_158: Z) ,
  [| (h_158 <> 0) |] 
  &&  [| (l = (cons (x_155) (l0_156))) |] 
  &&  [| (p_pre <> 0) |]
  &&  ((&((p_pre)  # "InequList" ->ₛ "coef")) # Ptr  |-> h_158)
  **  (InequList y_157 n l0_156 )
  **  ((&((p_pre)  # "InequList" ->ₛ "next")) # Ptr  |-> y_157)
  **  (coef_array h_158 n x_155 )
  **  ((( &( "p" ) )) # Ptr  |-> p_pre)
|--
  [| (0 <= INT_MAX) |] 
  &&  [| ((INT_MIN) <= 0) |]
...
forall (p_pre: Z) (l: (@list Constraint)) (x_155: Constraint) (l0_156: (@list Constraint)) (y_157: Z) (h_158: Z) ,
  [| (y_157 <> 0) |] 
  &&  [| (h_158 <> 0) |] 
  &&  [| (h_158 <> 0) |] 
  &&  [| (l = (cons (x_155) (l0_156))) |] 
...
Definition eliminate_entail_wit_3 := 
...
Definition eliminate_entail_wit_4 := 
forall (num_pre: Z) (l: (@list Constraint)) (n: Z) (BP0: Z) (retval: Z) (retval_2: Z) (retval_3: Z) (cur: Z) (remain: Z) (lower: Z) (upper: Z) (up_2: (@list Constraint)) (lo_2: (@list Constraint)) (re_2: (@list Constraint)) (bp_2: BP) (l1_2: (@list Constraint)) (l2_2: (@list Constraint)) (cur_next: Z) (cur_coef: Z) (x: Constraint) (l3: (@list Constraint)) ,
  [| ((coef_Znth (num_pre) (x) (0)) <= 0) |] 
  &&  [| ((coef_Znth (num_pre) (x) (0)) <> 0) |] 
  &&  [| (l2_2 = (cons (x) (l3))) |] 
...
Definition eliminate_entail_wit_5 := 
forall (num_pre: Z) (l: (@list Constraint)) (n: Z) (BP0: Z) (retval: Z) (retval_2: Z) (retval_3: Z) (cur: Z) (remain: Z) (lower: Z) (upper: Z) (up_2: (@list Constraint)) (lo_2: (@list Constraint)) (re_2: (@list Constraint)) (bp_2: BP) (l1_2: (@list Constraint)) (l2_2: (@list Constraint)) (cur_next: Z) (cur_coef: Z) (x: Constraint) (l3: (@list Constraint)) ,
  [| ((coef_Znth (num_pre) (x) (0)) > 0) |] 
  &&  [| ((coef_Znth (num_pre) (x) (0)) <> 0) |] 
  &&  [| (l2_2 = (cons (x) (l3))) |] 
...
Definition generate_new_constr_return_wit_1_1 := 
forall (cur_num_pre: Z) (num_pre: Z) (r2_pre: Z) (r1_pre: Z) (c2: Constraint) (c1: Constraint) (retval: Z) (lb2: Z) (ub2: Z) (lb1: Z) (ub1: Z) (i: Z) (m2: Z) (m1: Z) ,
  [| ((coef_Znth (i) (c1) (0)) > ub1) |] 
  &&  [| ((coef_Znth (i) (c1) (0)) >= lb1) |] 
  &&  [| (i <= num_pre) |] 
...
Definition generate_new_constr_return_wit_1_2 := 
forall (cur_num_pre: Z) (num_pre: Z) (r2_pre: Z) (r1_pre: Z) (c2: Constraint) (c1: Constraint) (retval: Z) (lb2: Z) (ub2: Z) (lb1: Z) (ub1: Z) (i: Z) (m2: Z) (m1: Z) ,
  [| ((coef_Znth (i) (c1) (0)) < lb1) |] 
  &&  [| (i <= num_pre) |] 
  &&  [| (m1 > 0) |] 
...
forall (cur_num_pre: Z) (num_pre: Z) (r2_pre: Z) (r1_pre: Z) (l_init: (@list Constraint)) (l2: (@list Constraint)) (l1: (@list Constraint)) (n: Z) (res: Z) (p1: Z) (l3_2: (@list Constraint)) (l4_2: (@list Constraint)) (l11_2: (@list Constraint)) (l12_2: (@list Constraint)) (p1_next_2: Z) (p1_coef_2: Z) (x: Constraint) (l13: (@list Constraint)) ,
  ...
  **  (InequList res n l3_2 )
|--
  EX p1_next p1_coef l3 l4 l21 l22 l11 x1 l12,
  [| (n = (num_pre + 1 )) |] 
  &&  [| (0 <= cur_num_pre) |] 
  &&  [| (cur_num_pre < n) |] 
  &&  [| (InequList_nth_pos cur_num_pre l1 ) |] 
...
Definition real_shadow_entail_wit_2 := 
...
Definition real_shadow_entail_wit_3 := 
forall (n_pre: Z) (pr_pre: Z) (l1: (@list Constraint)) (p1: Z) (BP0: Z) (BP0_upper: Z) (BP0_lower: Z) (BP0_remain: Z) (l2_2: (@list Constraint)) (cnt: Z) (BP0_remain_2: Z) (BP0_lower_2: Z) (BP0_upper_2: Z) (up: (@list Constraint)) (lo: (@list Constraint)) (re: (@list Constraint)) (b: BP) (l3: (@list Constraint)) (l4: (@list Constraint)) (retval: Z) ,
  [| (retval <> 0) |] 
  &&  [| (generate_new_constraints (Zto_nat ((cnt - 1 ))) up lo l4 ) |] 
  &&  [| (l3 = (app (l4) (re))) |] 
...
Axiom proof_of_eliminate_entail_wit_3 : eliminate_entail_wit_3.
Axiom proof_of_eliminate_entail_wit_4 : eliminate_entail_wit_4.
Axiom proof_of_eliminate_entail_wit_5 : eliminate_entail_wit_5.
...
Axiom proof_of_generate_new_constr_return_wit_1_1 : generate_new_constr_return_wit_1_1.
Axiom proof_of_generate_new_constr_return_wit_1_2 : generate_new_constr_return_wit_1_2.
...
Axiom proof_of_real_shadow_entail_wit_2 : real_shadow_entail_wit_2.
Axiom proof_of_real_shadow_entail_wit_3 : real_shadow_entail_wit_3.
