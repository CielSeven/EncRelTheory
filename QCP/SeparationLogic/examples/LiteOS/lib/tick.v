...
Definition atomic_cycleget: program (Los_Verify_State -> Prop) unit :=
  atomic_tick_cmd (fun s1 _ s2 => s2 = (mkTickAbstractState (timebase_turnover s1.(tgs_ts)) s1.(tgs_att))).