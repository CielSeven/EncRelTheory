...
From EncRelSeq.MonadsAsHigh.AbsMonad Require Import relhoarelogic encrel.
    ...
    - split;intros.
      ...
      + clear H3.
        ...
        specialize (H2 w _ _ _  hst1 hstmt H HP) as  Hnrm.
          ...
          exists hst2, hstmt2.
          split;auto.
          simpl_hdefs. unfold weakestpre. sets_unfold. auto.
      + apply funcspecs_nrm_equivforall.
        apply IHΓ.
  ...
  Proof.
    ...
    - unfold valid_contextualreltriple, valid_contextualrelT, valid_contextualtriple_nrm.
      ...
      specialize (HT H lst1 _ _ Hframe).
        ...
        unfold encode_asrt in H2. simpl_hdefs. 
        destruct H2 as [hst2 [hstmt2 [? ?]]];subst.
        do 2 eexists.
        split;eauto.
        unfold weakestpre in *. sets_unfold in H1.
        unfold config_refinement.
        apply H1.
  Qed. 
...
Proof.
  ...
  specialize (HRT (fun r (x: Σₕ) => (sₕ u) σₕ r x)).
  eapply hoare_conseq;eauto.
  ...
  - apply shallow_exp_left; intros a.
    ...
    intros [σₕ' [? ?]].
    specialize (H1 a σₕ' (ltac:(unfold_monad;auto))).
    specialize (HHT _ _ _ HPH H1).
    eexists.  split;eauto.
  Qed.
